  ...
  return (
    <div className="Home">
      ...
      <p className="sub_title">
        Welcome to India's First ever Ethereum Blockchain Hackathon at IIT
        Mumbai.
      </p>
      <button
        // style={{backgroundColor : bg}}
        className="btn"
        onClick={click === 0 ? eventHandling : submitLink}
      ...
      <p className="spons">
        <img src={logo} className="logo_img"></img>Consensya{" "}
        <span className="span">Ethereum Foundation</span>
      </p>
