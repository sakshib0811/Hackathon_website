            ...
            <div className="signupform">
              ...
              <form className='register-form' id='register-form'>
                <div className="form-group">
                  ...
                  <input type="email" name='name' id='name' autoComplete='off' placeholder='Your Email' />
                </div>
              </form><br />
              ...
              <form className='register-form' id='register-form'>
                <div className="form-group">
                  ...
                  <input type="number" name='name' id='name' autoComplete='off' placeholder='Mobile Number' />
                </div>
              </form><br />
